...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "logstash" do |logstash|
    ...
    logstash.vm.network "forwarded_port", guest: 1100, host: 1100
  ...
  config.vm.define "elasticsearch" do |elasticsearch|
    ...
    elasticsearch.vm.network "forwarded_port", guest: 1101, host: 1101
  ...
  config.vm.define "kibana" do |kibana|
    ...
    kibana.vm.network "forwarded_port", guest: 1102, host: 1102
